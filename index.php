...
<div id="welcomeLine" class="row">
	<div class="span6">
             ...
             <h4 align="left" style="color: #167231;"><?php echo @$_GET['valid']?></h4>
            <h4 align="left" style="color: springgreen;"><?php echo @$_GET['invalid']?></h4>
...
if ($_SESSION["usertype"]==0){
	...
	echo '<li class=""><a href="./View/edit_profile.php">Edit profile</a></li>';
    }
